...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (sel && sel.src) {
      ...
      addMessage('I\'ve selected this image for editing:', 'user', null);
      ...
      // Update UI
      promptEl.placeholder = 'Tell me how to remix this image...';
    ...
    generateBtn.addEventListener('click', async () => {
      ...
      try {
        ...
        if (result?.b64) {
          ...
          removeTypingIndicator();
          addMessage('Here\'s your remixed image:', 'ai', result.b64);
